...
[![Stable release](https://img.shields.io/github/v/release/masarray/obs-vst3?sort=semver&display_name=tag&label=stable&color=22c55e)](https://github.com/masarray/obs-vst3/releases/latest)
[![Windows x64](https://img.shields.io/badge/Windows-x64-0078D4?logo=windows11&logoColor=white)](https://github.com/masarray/obs-vst3/releases/latest/download/OBS-Safe-VST3-Host-Setup-x64.exe)
...
> **Public stable** · Single VST3 Host + isolated serial VST3 Rack · premium compact Rack Editor · Input Trim / Output Fader · LUFS-I + dBTP metering · automatic working-Rack recall · native vendor GUIs · presets · fail-dry recovery

**Website:** https://masarray.github.io/obs-vst3/  
**Direct installer:** https://github.com/masarray/obs-vst3/releases/latest/download/OBS-Safe-VST3-Host-Setup-x64.exe  
**Portable ZIP:** https://github.com/masarray/obs-vst3/releases/latest/download/OBS-Safe-VST3-Host-Windows-x64-Portable.zip  
**Release notes:** https://github.com/masarray/obs-vst3/releases/latest
...
**[Download the latest stable Smart Installer directly](https://github.com/masarray/obs-vst3/releases/latest/download/OBS-Safe-VST3-Host-Setup-x64.exe)**

The stable URL above does not contain a version number. Release automation publishes it as an alias of the newest qualified installer, so documentation and landing pages do not need manual URL changes for every release.

Close OBS, run the installer, select the OBS root containing `bin\64bit\obs64.exe`, then start OBS again.

For advanced/manual installation:

**[Download the latest portable ZIP directly](https://github.com/masarray/obs-vst3/releases/latest/download/OBS-Safe-VST3-Host-Windows-x64-Portable.zip)**

Every release also publishes **[SHA256SUMS.txt](https://github.com/masarray/obs-vst3/releases/latest/download/SHA256SUMS.txt)** for integrity verification.
...
The public release workflow rebuilds against pinned OBS/libobs and publishes the Smart Installer, portable ZIP and SHA-256 checksums only after its package tests pass. A follow-up release workflow publishes versionless stable aliases for the installer and portable package, which are the URLs used by the website and README.
...
Do not disable Defender or SmartScreen globally. Download only through the official repository/website links and verify `SHA256SUMS.txt` when you want an additional integrity check.
