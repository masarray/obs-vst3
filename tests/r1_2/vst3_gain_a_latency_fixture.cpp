...
namespace safevst3::r1_2_fixture_a {
using namespace Steinberg;
using namespace Steinberg::Vst;

static const FUID kProcessorUid(0xA1311201, 0x92D74B77, 0xA29D2F12, 0x01A20001);
constexpr auto kPluginName = "SafeVST3 R1-2 Gain A x2 latency 11";
constexpr SpeakerArrangement kArrangement = SpeakerArr::kStereo;
constexpr uint32 kLatencySamples = 11;

class GainA final : public AudioEffect {
public:
    static FUnknown* create_instance(void*) { return static_cast<IAudioProcessor*>(new GainA()); }
...
using namespace Steinberg;
using namespace Steinberg::Vst;
using safevst3::r1_2_fixture_a::GainA;
using safevst3::r1_2_fixture_a::kPluginName;
using safevst3::r1_2_fixture_a::kProcessorUid;
...
DEF_CLASS2(INLINE_UID_FROM_FUID(kProcessorUid), PClassInfo::kManyInstances, kVstAudioEffectClass,
           kPluginName, 0, "Fx", "1.0.0", kVstVersionString, GainA::create_instance)
END_FACTORY
