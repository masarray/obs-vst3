...
namespace safevst3::r1_1_fixture_a {
using namespace Steinberg;
using namespace Steinberg::Vst;

static const FUID kProcessorUid(0xA1311101, 0x92D74B77, 0xA29D2F12, 0x01A10001);
constexpr auto kPluginName = "SafeVST3 R1-1 Gain A x2";
...
using namespace Steinberg;
using namespace Steinberg::Vst;
using safevst3::r1_1_fixture_a::GainA;
using safevst3::r1_1_fixture_a::kPluginName;
using safevst3::r1_1_fixture_a::kProcessorUid;
