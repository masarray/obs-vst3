...
if(HOST_CONTEXT LESS 0 OR COMPONENT_INIT LESS 0 OR HANDLER LESS 0 OR CONNECT_FORWARD LESS 0 OR CONNECT_REVERSE LESS 0 OR
   SETUP LESS 0 OR ACTIVATE_BUSES LESS 0 OR SET_ACTIVE LESS 0)
...
if(NOT (HOST_CONTEXT LESS COMPONENT_INIT AND COMPONENT_INIT LESS HANDLER AND HANDLER LESS CONNECT_FORWARD AND
        CONNECT_FORWARD LESS CONNECT_REVERSE AND CONNECT_REVERSE LESS SETUP AND
        SETUP LESS ACTIVATE_BUSES AND ACTIVATE_BUSES LESS SET_ACTIVE))
  message(FATAL_ERROR "Strict lifecycle ordering regressed: initialize -> handler -> connect -> setup -> bus activation -> active")
endif()
